...
export default function Ilha_Comprida() {
  ...
  const fetchData = async () => {
    const result = await Api.get('weather?format=json-cors&key=7d1e670c&woeid=26804093&array_limit=10&fields=only_results,city_name,temp,description,date,time,rain,forecast,min,max,rain_probability');
